# Terms of Service - UnionEyes Mobile Application
...
By downloading, installing, or using the UnionEyes mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

UnionEyes provides a mobile platform for union members to:

- Submit and track claims
- Upload and manage documents
- Communicate with union staff
- Access union benefits and services
...
- Be a current union member or authorized representative
...
- Submit accurate and truthful claims
...
- Grant us license to process and store documents
- Ensure documents are legal and appropriate
...
- App and content are our property
...
- Grant us license to use content to provide services
...
- Some jurisdictions do not allow limitations, so these may not apply

## 10. Indemnification

You agree to indemnify and hold harmless UnionEyes from:
...
- We may release updates and new versions
- Updates may be required to continue using the App
- You should keep the App updated
...
- Arbitration conducted by [Arbitration Association]
- Location: [City, State]
...
These Terms constitute the entire agreement between you and UnionEyes regarding the App.
...
- California Civil Code Section 1542 waiver applies

### 19.2 EU Residents

- Right to withdraw consent within 14 days
- Standard EU consumer protection rights apply

### 19.3 Government Users

- Special terms may apply for government use
