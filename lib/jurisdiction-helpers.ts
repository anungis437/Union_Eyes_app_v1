...
export async function getTenantJurisdiction(tenantId: string): Promise<CAJurisdiction | null> {
  try {
    ...
    console.error('Error fetching tenant jurisdiction:', error);
    return null;
  }
}
/**
...
export async function getJurisdictionDeadline(
  ...
  try {
    ...
    console.error('Error fetching jurisdiction deadline:', error);
    return null;
  }
}
...
export async function calculateBusinessDaysDeadline(
  ...
  try {
    ...
    console.error('Error calculating business days deadline:', error);
    return null;
  }
}
