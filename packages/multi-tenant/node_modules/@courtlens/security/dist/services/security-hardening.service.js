...
exports.SecurityHardeningService = exports.ThreatType = void 0;
const logger_1 = require("../utils/logger");
const crypto_1 = __importDefault(require("crypto"));
var ThreatType;
(function (ThreatType) {
    ThreatType["BRUTE_FORCE"] = "brute_force";
    ThreatType["SUSPICIOUS_LOGIN"] = "suspicious_login";
    ThreatType["UNUSUAL_ACCESS_PATTERN"] = "unusual_access_pattern";
...
class SecurityHardeningService {
    constructor(auditService) {
        ...
        this.honeyTokens = new Set();
        this.logger = new logger_1.SecurityLogger('SecurityHardeningService');
    ...
    generateHoneyTokens() {
        ...
        for (let i = 0; i < 10; i++) {
            const honeyToken = `hny_${crypto_1.default.randomBytes(16).toString('hex')}`;
     ...
     */
    async handleFailedLogin(ip, userId) {
        const key = userId || ip;
    ...
    isIpBlocked(ip) {
        const blockRule = this.ipBlockList.get(ip);
        if (!blockRule || !blockRule.isActive)
            return false;
    ...
    async detectUnusualAccessPattern(req) {
...
exports.SecurityHardeningService = SecurityHardeningService;
//# sourceMappingURL=security-hardening.service.js.map