 ...
 */
export const updateUserJWTClaims = async (userId, claims) => {
    try {
 ...
 */
export const populateJWTClaimsFromProfile = async (userId) => {
    try {
        const supabase = getSupabaseClient();
        // Fetch user profile
 ...
 */
export const createUserProfileWithClaims = async (userId, role, organizationId, permissions) => {
    try {
        const supabase = getSupabaseClient();
 ...
 * @returns Promise<void>
 */
export const refreshJWTClaims = async () => {
    try {
        const supabase = getSupabaseClient();
        // Get current session
