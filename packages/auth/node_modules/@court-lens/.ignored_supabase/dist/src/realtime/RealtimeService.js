...
export class RealtimeService {
     ...
     */
    async trackPresence(organizationId, user) {
     ...
     */
    subscribeToDocumentChanges(documentId, organizationId, onUpdate) {
     ...
     */
    async broadcastCursorPosition(documentId, position) {
     ...
     */
    subscribeToMatterUpdates(organizationId, onUpdate) {
     ...
     */
    subscribeToNotifications(organizationId, userId, onNotification) {
     ...
     */
    subscribeToBillingUpdates(organizationId, onUpdate) {
    ...
    async unsubscribeAll() {
        const unsubscribePromises = Array.from(this.subscriptions.values()).map(subscription => subscription.channel.unsubscribe());
