...
/**
 * GET /api/cbas/[id]
 * Fetch a single CBA with optional related data
 * 
 * Query params:
 ...
 * Update CBA metadata
 * 
 * Body: Partial CBA object
 * Special field: status - will use updateCBAStatus
 */
 ...
 * 
 * Query params:
 * - hard: boolean - if true, performs hard delete (permanent)
 */
