...
const taxCopeReceiptsSchema = z.object({
  ...
  contributionType: z.unknown().optional().default('payroll_deduction'),
  paymentMethod: z.unknown().optional(),
  paymentReference: z.unknown().optional(),
  isEligibleForCredit: z.boolean().optional().default(true),
  receiptIssued: z.boolean().optional().default(true),
