...
export async function POST(request: NextRequest) {
  try {
    ...
    const newPrecedent: NewArbitrationPrecedent = {
      ...
      citationCount: 0,
      decisionDocumentUrl: body.decisionDocumentUrl || null,
      redactedDocumentUrl: body.redactedDocumentUrl || null,
      isMemberNamesRedacted: body.isMemberNamesRedacted ?? true,
      grievorNames: body.grievorNames || [],
      sharingLevel: body.sharingLevel || "federation",
      sharedWithOrgIds: body.sharedWithOrgIds || [],
      sector: body.sector || null,
      industry: body.industry || null,
      bargainingUnitSize: body.bargainingUnitSize || null,
      viewCount: 0,
      downloadCount: 0,
      uploadedBy: userUuid,
    };

    const [createdPrecedent] = await db
