...
const roleConfig: Record<MemberRole, { label: string; color: string; icon: JSX.Element }> = {
  ...
  officer: { label: "Officer", color: "text-orange-700 bg-orange-100 border-orange-200", icon: <Award className="w-3 h-3" /> },
  admin: { label: "Admin", color: "text-red-700 bg-red-100 border-red-200", icon: <Shield className="w-3 h-3" /> }
};
...
const statusConfig: Record<MemberStatus, { label: string; color: string; dotColor: string }> = {
  ...
  "on-leave": { label: "On Leave", color: "text-yellow-700 bg-yellow-100 border-yellow-200", dotColor: "bg-yellow-500" }
};
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Stewards</p>
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Avg. Seniority</p>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg mb-8">
            <CardContent className="p-6">
              ...
              <div className="relative mb-6">
                ...
                <input
                  type="text"
                  placeholder="Search by name, email, position, or membership number..."
                  value={searchQuery}
