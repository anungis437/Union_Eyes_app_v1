                    ...
                    {vote.status === "active" && !vote.hasVoted ? (
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                          <BarChart3 size={18} />
                          {vote.status === "closed" ? "Final Results" : "Current Results"}
                        </h4>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-6 md:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Union Votes</h1>
          <p className="text-gray-600 text-lg">Participate in decisions that shape your workplace</p>
        </motion.div>
        ...
        >
          <div className="flex gap-2 bg-white/80 backdrop-blur-sm p-2 rounded-lg border border-white/50 shadow-lg">
            {[
              { key: "active", label: "Active", count: activeVotes.length },
              { key: "upcoming", label: "Upcoming", count: upcomingVotes.length },
              { key: "past", label: "Past Results", count: pastVotes.length }
            ].map((tab) => (
              <button
                key={tab.key}
                ...
                {activeVotes.length === 0 ? (
                  <Card className="border-white/50 bg-white/80 backdrop-blur-sm shadow-lg">
                    <CardContent className="p-12 text-center">
                      ...
                      <h2 className="text-xl font-semibold text-gray-900 mb-2">No Active Votes</h2>
                      <p className="text-gray-600">Check back later for upcoming votes and ballots.</p>
                    </CardContent>
                  </Card>
                ) : (
                ...
                {upcomingVotes.length === 0 ? (
                  <Card className="border-white/50 bg-white/80 backdrop-blur-sm shadow-lg">
                    <CardContent className="p-12 text-center">
                      ...
                      <h2 className="text-xl font-semibold text-gray-900 mb-2">No Upcoming Votes</h2>
                      <p className="text-gray-600">Stay tuned for scheduled votes.</p>
                    </CardContent>
                  </Card>
                ) : (
