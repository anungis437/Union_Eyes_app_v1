  ...
  const metrics: Metric[] = [
    {
      ...
      value: "847",
      change: 12.5,
      changeLabel: "+12.5% from last period",
    ...
    },
    {
      ...
      value: "1,234",
      change: 8.2,
      changeLabel: "+8.2% from last period",
    ...
    },
    {
      ...
      value: "87.3%",
      change: 5.1,
      changeLabel: "+5.1% from last period",
    ...
    },
    {
      ...
      value: "12.4 days",
      change: -15.3,
      changeLabel: "-15.3% from last period",
    ...
    },
    {
      ...
      value: "92.1%",
      change: 3.7,
      changeLabel: "+3.7% from last period",
    ...
    },
    {
      ...
      value: "34",
      change: -8.5,
      changeLabel: "-8.5% from last period",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50">
      <div className="p-6 md:p-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">Comprehensive union metrics, trends, and performance data</p>
        </motion.div>
                  ...
                  {topStewards.map((steward, index) => (
                    <div key={steward.name} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{steward.cases} cases handled</p>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-bold text-indigo-600">{steward.rate}%</p>
                        <p className="text-xs text-gray-500">{steward.resolved} resolved</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm text-blue-700 font-medium">Open Cases</span>
                    </div>
                    <p className="text-2xl font-bold text-blue-900">124</p>
                    <p className="text-xs text-blue-600 mt-1">14.6% of total</p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-xs text-green-600 mt-1">85.4% of total</p>
                  </div>
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <div className="flex items-center gap-2 mb-2">
                      <Clock className="w-4 h-4 text-orange-600" />
                      <span className="text-sm text-orange-700 font-medium">Avg. Response</span>
                    </div>
                    <p className="text-2xl font-bold text-orange-900">2.1 hrs</p>
                    <p className="text-xs text-orange-600 mt-1">Within 24h target</p>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="flex items-center gap-2 mb-2">
                      <Users className="w-4 h-4 text-purple-600" />
                      <span className="text-sm text-purple-700 font-medium">Active Stewards</span>
                    </div>
                    <p className="text-2xl font-bold text-purple-900">18</p>
                    <p className="text-xs text-purple-600 mt-1">1.5% of members</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4">
                    Use these metrics to track union performance, identify trends, and make data-driven decisions. 
                    Monitor case resolution rates, member satisfaction, and steward performance to ensure effective representation.
                  </p>
