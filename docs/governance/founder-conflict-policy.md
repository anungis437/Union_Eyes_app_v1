...
To prevent conflicts of interest between Union Eyes founders and the union locals they serve, ensuring the platform remains authentically pro-union and free from management influence.

## Background

Union Eyes founders may have worked in various industries before starting the company. Some may have connections to management, employers, or anti-union organizations. This policy ensures complete transparency and prevents any conflicts that could undermine the platform's union-serving mission.

## Blind Trust Requirement

### When Required

A founder MUST establish a **blind trust** for their Union Eyes shares if they:

1. Currently hold OR previously held **union office** (elected or appointed)
2. Have **employer/management background** in industries where unions operate
3. Have **family members** in management positions at unionized companies
4. Hold **board seats** at companies with union-management conflicts
5. Own **shares** in companies currently facing union organizing
...
- **Arms-length**: Cannot have worked with founder in past 5 years
...
- **Status**: ✅ **Blind trust established**
  - Trustee: McCarthy Tétrault LLP (Trust Division)
  - Established: January 15, 2021
  - Expires: January 15, 2031 (10 years)
  - Annual report: Filed December 2025, reviewed by Board ✅
- **Union Eyes Role**: CTO (operational, no board seat during trust period)
...
- **Status**: ✅ **No blind trust required**
  - Direct ownership: Permitted
  - Voting rights: Full (subject to golden share Reserved Matters)
- **Union Eyes Role**: CEO
...
- **Status**: ✅ **Enhanced disclosure required** (no blind trust)
  - Annual conflict review: Required
  - Recusal: Required for any employer-related votes
  - Transparency: Public disclosure of HR background
- **Union Eyes Role**: COO
- **Board Seat**: Yes (with recusal requirements)

## Mandatory Resignation from Union Office
...
4. Compensation ceases (unless pre-arranged exit package)
...
4. Use union connections for **personal financial gain**
5. Participate in votes on contracts with **any union** (must recuse)
...
4. **No preferential treatment** (same terms as all union clients)
5. **Competitive bidding** (if contract >$50k)

### Example: Permitted Transaction

```
Union Eyes signs contract with CUPE Local 456 (Founder A's former local)

✅ Fair market value: $15,000/year (standard pricing)
✅ Board approval: Founder A recused, 4-0 vote by remaining directors
✅ Public disclosure: Published on website March 1, 2026
✅ No preferential terms: Standard contract, no discounts
✅ Competitive process: Local 456 evaluated 3 vendors
...
4. **Family members in management** at unionized companies (disclosure required)
5. **Business relationships with unions** (beyond Union Eyes contracts)
6. **Potential conflicts** arising in past year

**Declaration Form**: Signed, notarized, filed with Board and Union Member Representative Council
...
- Member protection effectiveness

**Last Audit**: December 2025 by Deloitte
**Result**: ✅ Compliant (minor recommendations implemented)
**Next Audit**: December 2028
...
- **Public disclosure** of violation and penalties
...
**Protection**: Whistleblowers protected from retaliation (termination, lawsuit, harassment)
...
4. All Ethics Committee decisions (redacted for privacy)
...
- Public apology
- Legal action by Union Eyes on behalf of whistleblower
...
4. Discipline founders for violations
...
**Last Amendment**: January 15, 2026 (added Founder C disclosure requirements)

---

**Policy Owner**: Board of Directors  
**Enforcer**: Ethics Committee  
**Reviewer**: External auditor (every 3 years)  
