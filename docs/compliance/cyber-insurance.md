...
4. Payment authorization (if recommended)
...
4. **Confidentiality**: NDA, encryption at rest/transit ✅
...
1. **Immediate Actions** (Within 1 hour)
   ...
   - Call insurance hotline: 1-800-XXX-XXXX

2. **Notification** (Within 24 hours)
   - Notify policy broker
   - File preliminary claim
...
- Member notification (mail, email, credit monitoring)
...
- No claims history: -10%

**Total Discount**: 40% ($20,000 savings)
...
- ❌ Social engineering (phishing) - limited coverage
...
**Policy Owner**: CTO / Risk Management Committee
