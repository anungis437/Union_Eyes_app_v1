# Union Eyes AI Governance Charter

**Version:** 1.0 (Draft)  
**Effective Date:** January 15, 2026  
**Review Cycle:** Annual  
**Status:** Pending Union Executive Board Approval
...
This charter establishes the Union Eyes AI Governance Committee, defines its authority, responsibilities, and operating procedures to ensure responsible, ethical, and effective use of artificial intelligence in service of labor unions and their members.

### Mission Statement

To provide strategic oversight and ethical guidance for all AI initiatives at Union Eyes, ensuring that AI technologies serve workers, strengthen unions, and uphold labor values of fairness, transparency, democracy, and solidarity.
...
- **Fair:** AI must not discriminate or perpetuate bias
- **Accountable:** Clear responsibility for AI outcomes
- **Secure:** Member data protection is paramount
...
- AI-related incident investigations
...
- Approve AI uses prohibited by law or union bylaws
- Make hiring/firing decisions for AI staff

### Escalation Path

**Level 1:** AI Governance Committee decision (majority vote)  
**Level 2:** Union Executive Board review (for major strategic decisions, budget >$100K, member rights)  
**Level 3:** Membership referendum (for fundamental changes to AI usage affecting all members)
...
- **Responsibilities:**
  ...
  - Liaise with Union Executive Board
  - Final authority on tie-breaking votes
...
1. **Chief Technology Officer**
   ...
   - **Qualifications:** AI/ML expertise, software architecture, security knowledge

2. **Data Science Lead**
   - **Term:** Ex-officio (as long as in role)
   - **Responsibilities:**
     - Model validation and accuracy reviews
...
- **Term:** 2 years (renewable)
- **Responsibilities:**
  - Legal compliance review (labor law, privacy, AI regulations)
  - Contract review for AI vendors
...
1. **Senior Steward (Elected Position)**
   ...
   - **Responsibilities:**
     - Represent steward perspective
     - User experience feedback
     - Practical implications assessment
     - Member communication liaison
   - **Qualifications:** 3+ years as steward, AI tool user, member trust

2. **Member-at-Large (Rank-and-File)**
   - **Term:** 2 years (elected by membership)
   - **Responsibilities:**
...
- **Responsibilities:**
  - Privacy impact assessments
  - Consent mechanism oversight
  - Data minimization enforcement
  - GDPR/PIPEDA compliance
  - Member data rights
- **Qualifications:** CIPP certification, privacy law expertise, data governance
...
- **Responsibilities:**
  - Ethical guidance on complex AI decisions
  - Review fairness audit methodologies
...
- **Qualifications:** Cybersecurity expertise, AI security knowledge
...
- Misconduct or ethics violations
...
- **Tie-Breaking:** Committee Chair casts deciding vote

**Proxy Voting:** Not allowed (members must attend to vote)

**Abstentions:** Allowed when conflict of interest exists (member must disclose and recuse)
...
- Limited to critical security issues, legal compliance
...
- External auditors: With committee approval
...
- Recommend improvements or sunsetting
...
|-----------|-------------------|--------------|
| **Low Risk** (e.g., document summarization) | CTO approval, committee notification | Light review at next meeting |
| **Medium Risk** (e.g., timeline forecasting) | Committee vote (simple majority) | Standard review process |
| **High Risk** (e.g., churn prediction, member profiling) | Committee vote (supermajority) + legal review | Deep review + pilot testing required |
| **Critical Risk** (e.g., organizing intelligence, automated discipline) | Committee vote (supermajority) + Board approval | Extensive review + ethics board + member input |
...
4. If bias detected:
   ...
   - Re-audit scheduled (30-60 days post-fix)
...
- Union Executive Board approval (for policies affecting member rights)
- Publication and communication to users
...
- Accuracy failures (major prediction errors)
...
4. **Committee Review:** Findings presented at next meeting (or special meeting if urgent)
5. **Remediation:** Approved fixes, timeline, responsible parties
...
- **Low:** Feature bugs, usability issues
...
## 6. Subcommittees & Working Groups
...
4. Assign chair and members (may include non-committee members)
...
- Town halls or webinars (quarterly)
- FAQ updates (ongoing)
...
- **Fairness Audits:** $40,000/year
  - Third-party auditors
  - Bias detection tools
  - Remediation efforts

- **Policy & Compliance:** $20,000/year
  - Legal reviews
  - Policy development
...
- Family members employed by AI companies
...
3. Determine if conflict is:
   ...
   - **Manageable:** Member recuses from specific votes
...
- **Owner:** AI Governance Committee (once formed)
- **Contact:** [ai-governance@unioneyes.org](mailto:ai-governance@unioneyes.org)

---

*"Democratic oversight ensures AI serves workers, not replaces them. This charter formalizes our commitment to responsible AI that strengthens unions and protects members."*
