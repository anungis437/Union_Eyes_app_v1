...
### `/validation`
Testing, validation, and compliance reports:
- `CLC_ALIGNMENT_VALIDATION.md` - CLC alignment validation
- `CLC_COMPLIANCE_VALIDATION.md` - CLC compliance validation
- `DATABASE_VALIDATION_REPORT.md` - Database validation results
- `PHASE_1_3_VALIDATION_COMPLETE.md` - Phase 1-3 validation completion
- `PHASE_1_3_VALIDATION_GUIDE.md` - Validation procedures guide
- `PHASE_5A-B-C_VALIDATION.md` - Phase 5A-B-C validation
- `RLS_TESTING_CHECKLIST.md` - Row-level security testing checklist
- `RLS_TESTING_SUMMARY.md` - RLS testing summary

## Quick Links

### Getting Started
1. [README](../README.md) - Project overview
2. [AI Quick Start](guides/AI_QUICK_START.md) - AI features quick start
3. [Portal Testing Launch Guide](guides/PORTAL_TESTING_LAUNCH_GUIDE.md) - Testing guide

### Security
1. [Production Readiness](security/OPTION_1_PRODUCTION_READINESS_COMPLETE.md)
2. [Input Validation](security/OPTION_2_INPUT_VALIDATION_COMPLETE.md)
3. [Rate Limiting](security/OPTION_3_RATE_LIMITING_COMPLETE.md)
4. [Enhanced Logging](security/OPTION_4_ENHANCED_LOGGING_COMPLETE.md)

### Deployment
1. [Azure Deployment](deployment/AZURE_DEPLOYMENT.md)
2. [Azure Credentials](deployment/AZURE_CREDENTIALS.md)

### Validation
1. [Database Validation Report](validation/DATABASE_VALIDATION_REPORT.md)
2. [RLS Testing Checklist](validation/RLS_TESTING_CHECKLIST.md)
3. [Phase 1-3 Validation](validation/PHASE_1_3_VALIDATION_COMPLETE.md)
