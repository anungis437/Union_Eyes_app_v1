...
export const caJurisdiction = pgEnum("ca_jurisdiction", ['CA-FED', 'CA-ON', 'CA-QC', 'CA-BC', 'CA-AB', 'CA-SK', 'CA-MB', 'CA-NB', 'CA-NS', 'CA-PE', 'CA-NL', 'CA-YT', 'CA-NT', 'CA-NU'])
...
(table) => {
	return {
		...
		idxAiQueryLogsTimestamp: index("idx_ai_query_logs_timestamp").using("btree", table.timestamp.desc().nullsFirst()),
	}
});
...
export const organizationMembers = pgTable("organization_members", {
	...
	tenantId: uuid("tenant_id").notNull(),
	// TODO: failed to parse database type 'tsvector' - commented out to allow build
...
(table) => {
	return {
		...
		idxClaimsTenantId: index("idx_claims_tenant_id").using("btree", table.tenantId.asc().nullsLast()),
