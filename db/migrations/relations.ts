...
import { votingSessions, voterEligibility, votingOptions, votingNotifications, collectiveAgreements, cbaClauses, cbaVersionHistory, benefitComparisons, organizations, digitalSignatures, signatureWorkflows, wageProgressions, bargainingNotes, cbaFootnotes, arbitrationDecisions, cbaContacts, aiDocuments, aiChunks, aiQueries, aiFeedback, organizationMembers, claims, claimUpdates, duesRules, memberDuesAssignments, duesTransactions, employerRemittances, strikeFunds, fundEligibility, picketAttendance, stipendDisbursements, publicDonations, hardshipApplications, arrearsCases, sharedClauseLibrary, arbitrationPrecedents, precedentTags, precedentCitations, organizationRelationships, clauseLibraryTags, votes, perCapitaRemittances, transactionClcMappings, votingAuditors, votingSessionAuditors, blockchainAuditAnchors, voteMerkleTree, votingSessionKeys, organizationHierarchyAudit, votingKeyAccessLog, members, jurisdictionRules, complianceValidations, memberPoliticalParticipation, electedOfficials, politicalCampaigns, legislationTracking, politicalActivities, trainingCourses, courseSessions, courseRegistrations, pensionPlans, pensionHoursBanks, pensionContributions, pensionTrusteeBoards, pensionTrustees, pensionTrusteeMeetings, pensionBenefitClaims, pensionActuarialValuations, hwBenefitPlans, hwBenefitEnrollments, hwBenefitClaims, trustComplianceReports, taxYearConfigurations, taxSlips, craXmlBatches, copeContributions, memberDemographics, payEquityComplaints, equitySnapshots, statcanSubmissions, organizingCampaigns, organizingContacts, organizingActivities, certificationApplications, organizingVolunteers, memberCertifications, trainingPrograms, programEnrollments } from "./schema";
...
// View relation removed - organizationMembersRelations only had view references
...
// View relation removed - tenantsInTenantManagement is a database view, not a table
...
export const claimsRelations = relations(claims, ({one, many}) => ({
	...
	// }),
	// tenantsInTenantManagement: one(tenantsInTenantManagement, {
	// 	fields: [claims.tenantId],
	// 	references: [tenantsInTenantManagement.tenantId]
	// }),
}));

// View relation removed - usersInUserManagement is a database view, not a table
