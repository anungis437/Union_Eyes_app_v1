...
export class WorkflowBuilderService {
   ...
   */
  private validateTrigger(trigger: WorkflowTrigger): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationError[] = [];
   ...
   */
  private validateAction(action: WorkflowAction): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationError[] = [];
   ...
   * Validate condition
   */
  private validateCondition(condition: WorkflowCondition): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationError[] = [];
   ...
   */
  private checkCircularReferences(actions: WorkflowAction[]): string | null {
    const visited = new Set<string>();
    const recursionStack = new Set<string>();

    const dfs = (actionId: string, path: string[]): string | null => {
   ...
   */
  private findOrphanedActions(actions: WorkflowAction[]): string[] {
