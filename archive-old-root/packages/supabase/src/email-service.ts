...
export class EmailService {
   ...
   */
  async sendEmail(emailData: SendEmailRequest): Promise<{ success: boolean; message?: string; error?: string }> {
    try {
  ...
  async sendWelcomeEmail(
    userEmail: string, 
    userData: { first_name: string; organization_name?: string }
...
export async function sendEmail(emailData: SendEmailRequest) {
