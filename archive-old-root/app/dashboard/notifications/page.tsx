...
export default function NotificationsPage() {
  ...
  const categories = [
    ...
    { id: "vote", label: "Votes", icon: <CheckCircle className="w-4 h-4" /> },
    {
      id: "meeting",
      label: "Meetings",
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600">
                Stay updated on cases, deadlines, and union activities
              </p>
            </div>
                          ...
                          <div className="flex flex-wrap gap-3 mb-3">
                            ...
                            {notification.metadata.daysRemaining !==
                              ...
                              >
                                ...
                                {notification.metadata.daysRemaining} days left
                              </div>
                            )}
