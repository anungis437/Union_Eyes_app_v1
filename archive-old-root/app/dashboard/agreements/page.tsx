...
const typeConfig: Record<AgreementType, { label: string; color: string; icon: JSX.Element }> = {
...
const statusConfig: Record<AgreementStatus, { label: string; icon: JSX.Element; color: string }> = {
  active: { 
    label: "Active", 
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Access and review your union contracts, agreements, and policies
          </p>
        </div>
